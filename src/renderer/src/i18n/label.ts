...
const shortcutKeyMap = {
  ...
  show_shortcuts_help: 'settings.shortcuts.show_shortcuts_help',
  switch_tab_1: 'settings.shortcuts.switch_tab_1',
  switch_tab_2: 'settings.shortcuts.switch_tab_2',
  switch_tab_3: 'settings.shortcuts.switch_tab_3',
  switch_tab_4: 'settings.shortcuts.switch_tab_4',
  switch_tab_5: 'settings.shortcuts.switch_tab_5',
  switch_tab_6: 'settings.shortcuts.switch_tab_6',
  switch_tab_7: 'settings.shortcuts.switch_tab_7',
  switch_tab_8: 'settings.shortcuts.switch_tab_8',
  switch_tab_9: 'settings.shortcuts.switch_tab_9',
